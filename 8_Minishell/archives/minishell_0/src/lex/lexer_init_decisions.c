...
/*   Updated: 2022/09/26 02:27:21 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_init_decision_1(t_lex *lex)
{
	...
	lex->decision[NEW_MODE][SPL_CHAR] = (t_lex_proc){KEEP, SKIP, SPL_MODE, NEW};
	lex->decision[NEW_MODE][DBL_CHAR] = (t_lex_proc){KEEP, SKIP, DBL_MODE, NEW};
	...
	lex->decision[STD_MODE][SPL_CHAR] = (t_lex_proc){KEEP, SKIP, SPL_MODE, SPL};
	lex->decision[STD_MODE][DBL_CHAR] = (t_lex_proc){KEEP, SKIP, DBL_MODE, DBL};
...
int	ft_init_decision_2(t_lex *lex)
{
	...
	lex->decision[SPL_MODE][SPL_CHAR] = (t_lex_proc){CATCH, SKIP, NEW_MODE, NEW};
	...
	lex->decision[DBL_MODE][DBL_CHAR] = (t_lex_proc){CATCH, SKIP, NEW_MODE, NEW};
