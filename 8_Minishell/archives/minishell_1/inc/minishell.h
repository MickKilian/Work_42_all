...
/*   Updated: 2022/09/28 00:19:04 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_init_pars_decisions(t_lex *lex);
...
/* ************************************************************************** */
int				ft_init_pars_decision_1(t_lex *lex);
int				ft_init_pars_decision_2(t_lex *lex);
int				ft_init_pars_decision_3(t_lex *lex);
int				ft_init_pars_decision_4(t_lex *lex);
int				ft_init_pars_decision_5(t_lex *lex);
int				ft_init_pars_decision_6(t_lex *lex);
int				ft_init_pars_decision_7(t_lex *lex);
...
/*                            parser_actions.c                                 */
/* ************************************************************************** */
int				ft_init_pars_actions(t_lex *lex);
int				ft_pars_catch(t_lex *lex);
int				ft_pars_keep(t_lex *lex);
int				ft_pars_drop(t_lex *lex);
int				ft_pars_take(t_lex *lex);
int				ft_pars_skip(t_lex *lex);
int				ft_pars_record(t_lex *lex);
int				ft_pars_end(t_lex *lex);
int				ft_pars_synt_err(t_lex *lex);
