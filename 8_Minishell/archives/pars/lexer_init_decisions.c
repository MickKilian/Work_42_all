...
/*   Updated: 2022/10/11 00:45:36 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	lex->decision[NEW_LEX_RD_MD][SEP_CHAR] = (t_lex_proc){LEX_KEEP, LEX_SKIP, NEW_LEX_RD_MD, TOK_WORD};
...
//	lex->decision[NEW_LEX_RD_MD][ESCP_CHAR] = (t_lex_proc){LEX_KEEP, LEX_SKIP, ESCP_LEX_RD_MD, TOK_NEW};
	...
	lex->decision[NEW_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_END, LEX_TAKE, NEW_LEX_RD_MD, TOK_WORD};
	lex->decision[STD_LEX_RD_MD][SEP_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, NEW_LEX_RD_MD, TOK_WORD};
...
//	lex->decision[STD_LEX_RD_MD][ESCP_CHAR] = (t_lex_proc){LEX_KEEP, LEX_SKIP, ESCP_LEX_RD_MD, TOK_WORD};
	...
	lex->decision[STD_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, NEW_LEX_RD_MD, TOK_WORD};
	return (0);
}
