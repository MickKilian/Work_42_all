...
/*   Updated: 2022/09/01 05:11:27 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*ft_philolife(void *philo_)
{
	...
	pthread_mutex_lock(&philo->param->start_ex);
	pthread_mutex_unlock(&philo->param->start_ex);
	if (philo->id % 2 == 0)
		ft_myusleep(philo, philo->param->tm_eat / 3);
