...
/*   Updated: 2022/09/01 02:49:28 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_ARG1 "ARG 1: number_of_philsophers has to a be valid number > 1"
# define ERR_ARG2 "ARG 2: time_to_die (ms) has to be a valid positive number"
# define ERR_ARG3 "ARG 3: time_to_eat (ms) has to be a valid positive number"
# define ERR_ARG4 "ARG 4: time_to_sleep (ms) has to be a valid positive number"
...
void	ft_displaystatus(t_philo *philo, long long time);
